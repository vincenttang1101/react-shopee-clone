...
import { NoCart } from '@/assets/icons'
...
export default function Cart() {
  ...
  const totalPurchases = useMemo(
    () => checkedPurchases.reduce((total, purchase) => total + purchase.buy_count * purchase.price, 0),
    [checkedPurchases]
  )
  ...
  const isCheckAll = useMemo(() => extendedPurchases.every((purchase) => purchase.isChecked), [extendedPurchases])
  ...
  return (
    <main className='bg-[#f5f5f5] py-10'>
                      ...
                      <div className='col-span-7 grid grid-cols-6 text-gray-500 items-center'>
                        ...
                        <div className='text-primaryColor flex items-start col-span-1 justify-center'>
                          ...
                          <span className='leading-none'>
                            {Util.formatCurrency(purchase.price * purchase.buy_count)}
                          </span>
                        </div>
        ...
        <div>
          <div className='container'>
            <div className='flex flex-col gap-4 items-center justify-center'>
              <img className='w-[108px] h-[98px]' src={NoCart} alt='No cart' />
              <div className='text-gray-400 font-semibold'>Giỏ hàng của bạn còn trống</div>
              <Link
                className='rounded-sm uppercase text-lg text-white min-w-[167px] h-[36px] p-2 hover:opacity-95 bg-primaryColor flex items-center justify-center'
                to={PathConstant.home}
              >
                Mua ngay
              </Link>
            </div>
